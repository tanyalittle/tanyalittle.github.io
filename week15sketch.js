...
function setup()
{
    ...
    // call rectangleObject(x, y, w, h, r, g, b) to create rectangle class objects
	// x = x-coordinate, y = y-coordinate, w = width, h = height, r = red, g = green, b = blue
    box1 = new Rectangle(400, 100, 50, 50, 220, 35, 110);
    box2 = new Rectangle(215, 285, 70, 10, 220, 135, 10);

    // call quadrilateralObject(x1, y1, x2, y2, x3, y3, x4, y4, r, g, b) to create quadrilateral class objects
	// xn = x-coordinates, yn = y-coordinates, r = red, g = green, b = blue
    quad1 = new Quadrilateral(438, 431, 466, 420, 469, 463, 430, 476, 100, 70, 50);
    quad2 = new Quadrilateral(78, 71, 186, 120, 169, 163, 130, 176, 20, 170, 150);
}
...
function draw() 
{
    ...
    // create and display rectangle class objects
    box1.display();
    box2.display();

    // create and display quadrilateral class objects
    quad1.display();
    quad2.display();
}
